package com.rafi.presensi.adapter;
...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.MyViewHolder> {
    ...
    public ListAdapter(Context context, List<Pegawai> pegawaiList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.daftar_items, parent, false);
